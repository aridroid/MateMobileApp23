                        ...
                        if(widget.messageId!=""){
                          for(int i=0; i< widget.messageReaction.length ;i++){
                            if(widget.messageReaction[i].contains(widget.userId)){
                              ...
                              await DatabaseService(uid: widget.userId).setMessageReactionOneToOne(widget.personChatId, widget.messageId, '❤',widget.displayName,widget.photo);
                              break;
                            }
                          }
                          if(add){
                            DatabaseService(uid: widget.userId).setMessageReactionOneToOne(widget.personChatId, widget.messageId, '❤',widget.displayName,widget.photo);
                          }
                        }
                      },
                      child: Text('❤',
