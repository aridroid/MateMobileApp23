                                    ...
                                    subtitle: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "${snapshot.data['isImage'] != null ? snapshot.data['isImage'] ? " 🖼️ Image" : snapshot.data['isGif'] != null ? snapshot.data['isGif'] ? " 🖼️ GIF File" : snapshot.data['isFile'] ? "File" : snapshot.data['recentMessage'] : snapshot.data['recentMessage'] : snapshot.data['recentMessage']}",
                                            style: TextStyle(
                                              fontFamily: "Poppins",
                                              fontSize: 14.0,
                                              letterSpacing: 0.1,
