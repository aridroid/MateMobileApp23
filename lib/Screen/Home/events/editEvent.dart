...
class _EditEventState extends State<EditEvent> {
  ...
  void setPreviousData(){
    ...
    _time.text = widget.data.time.split('T').last.substring(0,5);
    _timeEnd.text = widget.data.endTime.split('T').last.substring(0,5);
    _linkText.text = widget.data.hyperLinkText;
    _link.text = widget.data.hyperLink;
    dateValue = widget.data.date.toString();
    timeValue = widget.data.time;
          ...
          child: ElevatedButton(
            ...
            onPressed: ()async{
              if(_formKey.currentState.validate()){
                ...
                String response = await _eventService.updateEvent(
                  id: widget.data.id,
                  title: _title.text,
                  ...
                  isImageDeleted: imagedDeleted && _image==null,
                  isVideoDeleted: videoDeleted && _video==null,
                );
                setState(() {
                  isLoading = false;
                });
                if(response=="Event updated successfully"){
                  Get.back();
                  Fluttertoast.showToast(msg: "Event updated successfully", fontSize: 16, backgroundColor: Colors.black54, textColor: Colors.white, toastLength: Toast.LENGTH_LONG);
                }else{
