...
class _CampusTalkState extends State<CampusTalk> {
  ...
  Future<void> startAudio(String url,int index) async {
    print(url);
    print(index);
    print(campusTalkProvider.campusTalkPostsResultsYourCampusList[index].isPaused);
    if(campusTalkProvider.campusTalkPostsResultsYourCampusList[index].isPaused==true){
      ...
      campusTalkProvider.campusTalkPostsResultsYourCampusList[index].isPaused = false;
      audioPlayer.play();
      setState(() {
        campusTalkProvider.campusTalkPostsResultsYourCampusList[index].isPlaying = true;
      });
      audioPlayer.playerStateStream.listen((state) {
        if (state.processingState == ProcessingState.completed) {
          setState(() {
            campusTalkProvider.campusTalkPostsResultsYourCampusList[index].isPlaying = false;
            campusTalkProvider.campusTalkPostsResultsYourCampusList[index].isPaused = false;
          });
        }
      });
      ...
      try{
        ...
        if(File(filePathAndName).existsSync()){
          ...
          setState(() {
            campusTalkProvider.campusTalkPostsResultsYourCampusList[index].isLoadingAudio = true;
          });

          String path = await downloadAudio(url);

          setState(() {
            campusTalkProvider.campusTalkPostsResultsYourCampusList[index].isLoadingAudio = false;
          });
  ...
  void pauseAudio(int index)async{
    ...
    setState(() {
      campusTalkProvider.campusTalkPostsResultsYourCampusList[index].isPlaying = false;
      campusTalkProvider.campusTalkPostsResultsYourCampusList[index].isPaused = true;
    });
  }
