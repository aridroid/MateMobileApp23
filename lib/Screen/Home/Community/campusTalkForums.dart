    ...
    if (_scrollController.position.atEdge) {
      if (_scrollController.position.pixels != 0) {
        Future.delayed(Duration.zero, () {
          ...
          Provider.of<CampusTalkProvider>(context, listen: false).fetchCampusTalkPostForumsList(page: _page,paginationCheck: true);
        });
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    return Consumer<CampusTalkProvider>(
      builder: (ctx, campusTalkProvider, _) {
        if (campusTalkProvider.talkPostForumsLoader && campusTalkProvider.campusTalkPostsResultsForumsList.length == 0) {
        ...
        return campusTalkProvider.campusTalkPostsResultsForumsList.length == 0 ?
        Center(
          child: Text(
            'Nothing new',
            style: TextStyle(
