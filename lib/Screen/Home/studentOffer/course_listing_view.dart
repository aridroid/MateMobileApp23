...
class CourseListingView extends StatelessWidget {
  CourseListingView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GetBuilder<StudentOfferController>(
      builder: (studentOfferController){
        return studentOfferController.isLoadingCourse?
        timelineLoader():
        ...
        ListView.builder(
          ...
          itemCount: studentOfferController.courseList.length,
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    studentOfferController.courseList[index],
                    style: TextStyle(
                      fontSize: 15,
                      fontFamily: 'Poppins',
                      fontWeight: FontWeight.w500,
