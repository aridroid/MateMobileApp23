class BeAMatePostsModel {
  bool success;
  Data data;
  String message;

  BeAMatePostsModel({this.success, this.data, this.message});

  BeAMatePostsModel.fromJson(Map<String, dynamic> json) {
...
class Result {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['portfolio_link'] = this.portfolioLink;
